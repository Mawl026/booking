...
public class BookingFacade {
    ...
    public void updateBooking() throws  UserException {
        bookingMapper.updateBookings();
    }

    public Booking createBooking(String booking_date, int days, String comment, boolean booking_status, int user_id, int item_id) throws UserException {
